...
const { FiCloud, FiMail, FiLinkedin, FiTwitter, FiGithub, FiHeart, FiArrowUp, FiExternalLink, FiCode, FiShare2 } = FiIcons;
    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Resources & Tools */}
          <div>
            <h3 className="text-lg font-semibold mb-4">🛠️ For Partners</h3>
            <ul className="space-y-3">
              {[
                'Embed Calculator',
                'Partner Resources',
            ...
            <div className="mt-6">
              ...
              <div className="bg-gray-800 p-3 rounded-lg text-xs">
                <code className="text-gray-300">
                  &lt;iframe src="https://fabric.m365calc.com"<br/>
        ...
        <div className="border-t border-gray-800 pt-8 mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 text-sm">
            ...
            <div>
              <h5 className="font-semibold text-gray-300 mb-2">3. Find Partners</h5>
              <p className="text-gray-400">Use email templates to contact Microsoft Partners and consultants</p>
            </div>
            <div>
